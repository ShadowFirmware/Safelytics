...
const styles = StyleSheet.create({
  ...
  title:       { fontSize: 22, fontWeight: '800', color: Colors.textDark, paddingHorizontal: 20, paddingTop: 16, paddingBottom: 4 },
  todayCard:   { backgroundColor: Colors.success + '1A', borderRadius: 16, padding: 20, marginBottom: 12, borderWidth: 1, borderColor: Colors.success + '33' },
  todayLabel:  { color: Colors.textLight, fontSize: 12, marginBottom: 4 },
  todayAmount: { fontSize: 24, fontWeight: '800', color: Colors.success },
  card:        { flexDirection: 'row', alignItems: 'center', backgroundColor: Colors.white, borderRadius: 14, padding: 14, gap: 10 },
  arrow:       { fontSize: 18, color: Colors.success, fontWeight: '800' },
  amount:      { fontSize: 15, fontWeight: '700', color: Colors.textDark },
  hash:        { fontSize: 11, color: Colors.textLight, fontFamily: 'monospace' },
